...
function show_mainpage_tab_03()
{
    ...
    ?>
    <div class="form-wrap">
        <h2><?php echo __( 'Email template for participants', 'cmta-ticketpool'); ?></h2>
        <form id="cmkk-mail-template-form" method="post" class="validate">
            ...
            <table class="form-table">
                <tr>
                    <th><?php echo __( 'Subject', 'cmta-ticketpool' ); ?></th>
                    <td>
                ...
                <tr>
                    <th><?php echo __( 'Message', 'cmta-ticketpool' ); ?></th>
                    <td>
                ...
                <tr>
                    <th></th>
                    <td>
                        <button type="submit" name="action" class="button button-primary" value="update-template"><?php echo __( 'Update', 'cmta-ticketpool' ); ?></button>
                    </td>
                </tr>
            </table>
