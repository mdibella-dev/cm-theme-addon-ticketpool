...
{
    add_menu_page(
        __( 'Ticket contingents', 'cm-addon-ticketpool' ),
        __( 'Ticket contingents', 'cm-addon-ticketpool' ),
        'manage_options',
        'cmkk_mainpage',
...
function show_mainpage()
{
    ...
    $tabs = array(
        'tab-01' => array(
            ...
            'title'    => __( 'Participants', 'cm-addon-ticketpool'),
        ),
        'tab-02' => array(
            'callback' => __NAMESPACE__ . '\show_mainpage_tab_02',
            'title'    => __( 'Ticket contingents', 'cm-addon-ticketpool'),
        ),
        'tab-03' => array(
            'callback' => __NAMESPACE__ . '\show_mainpage_tab_03',
            'title'    => __( 'Email notification', 'cm-addon-ticketpool'),
        ),
    );
    ...
    ?>
    <div class="wrap">
        <h1 class="wp-heading-inline"><?php echo __( 'Ticket contingents', 'cm-addon-ticketpool' )?></h1>
