...
function shortcode_form( $atts, $content = null )
{
    ...
    <form class="cmkk-form" method="post" action="">
        <table>
            <tr>
                <th><?php echo __( 'Your first name', 'cmta-ticketpool'); ?></th>
                <td>
                    <input id="vorname" name="cmkk_forename" type="text" value="<?php echo $user_forename; ?>">
                </td>
            </tr>
            <tr>
                <th><?php echo __( 'Your last name', 'cmta-ticketpool'); ?></th>
                <td>
                    <input id="nachname" name="cmkk_lastname" type="text"value="<?php echo $user_lastname; ?>">
                </td>
            </tr>
            <tr>
                <th><?php echo __( 'Your email address', 'cmta-ticketpool'); ?></th>
                <td>
                ...
                <td>
                    <div class="cmkk-gdpr">
                        ...
                        <label for="gdpr"><?php echo sprintf(
                            __( 'I agree that my data will be stored and processed for the purpose of contacting me. More information on this in the %1$s.', 'cmta-ticketpool' ),
                            sprintf(
                                '<a href="%1$s">%2$s</a>',
                                get_privacy_policy_url(),
                                __( 'privacy policy', 'cmta-ticketpool' )
                            )
                        );
                        ?></label>
                    </div>
            ...
            <tr>
                <th>
                    <div class="wp-block-button">
                        <button id="cmkk-submit" type="submit" class="wp-block-button__link" name="action" value="add" disabled="disabled"><?php echo __( 'Request participation', 'cmta-ticketpool' );?></button>
                    </div>
                </th>
                <td></td>
            </tr>
